...
import { createFlexifitFeedback } from "./graphql/mutations";
const client = generateClient();
export default function FlexifitFeedbackCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setJobLocation(initialValues.jobLocation);
    ...
    setCareerAmbition(initialValues.careerAmbition);
    setFinancialDrive(initialValues.financialDrive);
    setLearningReadiness(initialValues.learningReadiness);
    setJobSearch(initialValues.jobSearch);
    setJobSuccess(initialValues.jobSuccess);
    setLastWorked(initialValues.lastWorked);
    setMaritalStatus(initialValues.maritalStatus);
    setSingleType(initialValues.singleType);
    setKidsAge(initialValues.kidsAge);
    setSpouseSupportKids(initialValues.spouseSupportKids);
    setHelperSupportKids(initialValues.helperSupportKids);
    setFamilySupportKids(initialValues.familySupportKids);
    setSpouseSupportHousehold(initialValues.spouseSupportHousehold);
    setHelperSupportHousehold(initialValues.helperSupportHousehold);
    setFamilySupportHousehold(initialValues.familySupportHousehold);
    setCareGiving(initialValues.careGiving);
    setExtentOfCareGiving(initialValues.extentOfCareGiving);
    setHelperSupportCareGiving(initialValues.helperSupportCareGiving);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFlexifitFeedback.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FlexifitFeedbackCreateForm")}
      {...rest}
    >
      <TextField
